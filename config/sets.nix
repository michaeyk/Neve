  ...
  config = {
    opts = {
      ...
      guicursor = [
        ...
        "ci-ve:block" # Insert, command-line insert, visual-exclude: vertical bar cursor with block cursor, use "ver25" for 25% width
        "i:ver25" # Insert: vertical bar cursor with 25% width
